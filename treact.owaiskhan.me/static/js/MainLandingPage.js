...
import {
    ReactComponent as RadioIcon
} from "feather-icons/dist/icons/radio.svg";
import {
    ReactComponent as HandleIcon
} from "images/handle-icon.svg";
import {
    ReactComponent as ArrowRightIcon
} from "images/arrow-right-3-icon.svg";
...
const UpdateNoticeIcon = tw(RadioIcon)
`w-0 sm:w-5 sm:mr-3`;
...
`;
const PreviewButton = tw(PrimaryButtonBase)
...
export default ({
    ...
    return ( <
        ...
        <
        UpdateNoticeIcon / >
        Last updated on 20 th April, 2021 - Added support
        for React v17 and TailwindCSS v2!
        <
        /UpdateNotice> <
        TextColumn >
        <
        ...
        premade landing pages.Click on the "View Live Demo"
        button to see them in
        ...
        PreviewCards > {
            Object.entries(landingPages).map(([pageName, page], index) => ( <
                PreviewCardContainer key = {
                    index
                } >
                <
                PreviewCard initial = "rest"
                animate = "rest"
                whileHover = "hover"
                href = {
                    page.url
        ...
        for your various needs like a signup, login,
        pricing, about us, contact, blog etc.To view them in action click the "View Live Demo"
        button. <
        /SectionDescription> <
        PreviewCards > {
        ...
        components along with the premade landing pages so you can create your own landing page within minutes as you see fit.You can combine these components to create 1000 s of
    ...
    return ( <
        ...
        Components > {
            Object.values(components.elements).map((component, componentIndex) => ( <
                ...
                ComponentPreviewLink className = "group"
                href = {
                    component.url
                }
                target = "_blank" >
                ...
                width = "100%"
                ref = {
                    ref => (componentBlockRefs[component.url] = ref)
                }
                onLoad = {
                    e => updateComponentBlockIframeHeight(e.target)
                }
                /> <
                /ResizableBox> <
                /ComponentContent> <
