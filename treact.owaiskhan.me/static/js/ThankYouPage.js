...
`text-center text-primary-900 leading-snug`;
const Description = tw(DescriptionBase)
...
export default () => {
    ...
    return ( <
        ...
        Description tw = "mt-12" > Your Download Will Begin Shortly.If it does not, < NavLink href = {
            downloadUrl
        }
        download > click this link < /NavLink>.</Description >
        <
        ...
        <
        a href = "https://twitter.com/owaiswiz?ref_src=twsrc%5Etfw"
        ...
        div tw = "mt-8" >
        <
        GitHubButton href = "https://github.com/owaiswiz"
        data - size = "large"
        data - show - count = "true"
