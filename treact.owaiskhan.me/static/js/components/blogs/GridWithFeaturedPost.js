...
const DecoratorBlob1 = tw(SvgDotPatternIcon)
...
const DecoratorBlob2 = tw(SvgDotPatternIcon)
...
export default ({
    ...
    posts = [{
            ...
            authorImageSrc: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.95&w=512&h=512&q=80",
                                ...
                                Posts > {
                                    posts.map((post, index) => ( <
                                            ...
                                            PostTitle > {
                                                ...
                                                post.featured && < PostDescription > {
                                                        post.description
                                                    } < /PostDescription>} <
                                                    AuthorInfo > {
                                                        post.featured && < AuthorImage src = {
                                                            post.authorImageSrc
                                                        }
                                                        />} <
                                                        AuthorTextInfo >
