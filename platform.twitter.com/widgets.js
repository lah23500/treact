Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
    ...
    t.exports = {
        ...
        isHorizonLangSupported: i,
        isHorizonTimelineEnabled: function(t, e, o) {
            var s = t && t[n] && "treatment" === t[n].bucket,
                a = r(e),
                u = i(o);
            return s && a && u
        }
    ...
    t.exports = {
        version: "c8fe9736dd6fb:1649830956492"
    }
}, function(t, e) {
    t.exports = function(t) {
    ...
    r = function() {
        ...
        function N(e, n, r) {
            n.constructor === e.constructor && r === y && n.constructor.resolve === b ? function(t, e) {
                e._state === T ? L(t, e._result) : e._state === S ? I(t, e._result) : j(e, void 0, function(e) {
                    return P(t, e)
                }, function(e) {
                    return I(t, e)
                })
            }(e, n) : r === A ? (I(e, A.error), A.error = null) : void 0 === r ? L(e, n) : t(r) ? function(t, e, n) {
                o(function(t) {
                    var r = !1,
                        i = function(t, e, n, r) {
                            try {
        ...
        function D(e, n, r, i) {
            ...
            if (o) {
                if ((s = function(t, e) {
                    ...
                    }(r, i)) === A ? (c = !0, a = s.error, s.error = null) : u = !0, n === s) return void I(n, new TypeError("A promises callback cannot return that same promise."))
            } else s = i, u = !0;
            n._state !== x || (o && u ? P(n, s) : c ? I(n, a) : e === T ? L(n, s) : e === S && I(n, s))
        }
        var z = 0;
    ...
    t.exports = function(t, e, n, h) {
        var p, m = s.get(t.id),
            v = t.lang || "en",
            g = i.isHorizonTimelineEnabled(h, m, v);
        return a(m, v), g ? (p = r.createElement("div"), new o(c, u, f.TIMELINE, t, e, n, {
            sandboxWrapperEl: p
    ...
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.bbd13993eb53d3a11ac08f5e8cf9d6a4.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.bbd13993eb53d3a11ac08f5e8cf9d6a4.{{lang}}.html",
        hubHtmlPath: "/widgets/hub.html",
        widgetIframeHtmlPath: "/widgets/widget_iframe.bbd13993eb53d3a11ac08f5e8cf9d6a4.html",
    ...
    var r = n(75),
        ...
        o = n(31);
    t.exports = function(t, e) {
        return o.getHorizonSettings().then(function(n) {
            var o, s = n.features,
                a = n.sessionId;
            s && (o = s[i.HORIZON_TIMELINE_EXP_KEY]) && o.bucket && i.isHorizonTimelineVariantSupported(t) && i.isHorizonLangSupported(e) && r(i.HORIZON_TIMELINE_EXP_KEY, o.bucket, o.version, {}, a)
        })
    }
}, function(t, e, n) {
    var r = n(2);
